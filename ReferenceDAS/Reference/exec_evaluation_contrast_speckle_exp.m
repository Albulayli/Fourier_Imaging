function exec_evaluation_contrast_speckle_exp(path_image,path_output)
    ...
    %-- Evaluation: exp.con. phantom vs reconstructed image (RF)
 
    
    addpath(genpath('../Reference/picmus_src'));
    
%     path_scan = ['../Reference/picmus_database/experiments/contrast_speckle/contrast_speckle_expe_scan.hdf5'];
    path_phantom = ['../Reference/picmus_database/experiments/contrast_speckle/contrast_speckle_expe_phantom.hdf5'];

    
    %-- Parameters
%     category = [1 11 75];

    load(path_image);	%-- MAT structure identifier: "expcon_image"
    img = expcon_image;
